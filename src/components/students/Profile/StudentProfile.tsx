    ...
    <div className="w-full h-[95vh] overflow-y-auto  mx-auto p-8 bg-gradient-to-tr from-green-100 via-white to-blue-100 rounded-xl shadow-2xl ">
      <div className="flex flex-col md:flex-row gap-8">
        <ProfileHeader
          ...
          bio={formData.name ? `Student at ${formData.college}` : "Student Bio"}
        />
      ...
      <div className="flex justify-end">
        <button
          ...
          className="bg-green-600 text-black rounded-full px-10 py-3 shadow-lg hover:bg-green-700 font-semibold transition duration-300 transform hover:scale-105"
