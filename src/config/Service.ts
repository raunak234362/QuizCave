    ...
    class Service {
        ...
        static async studentContestAttempt({ id, token, answers }: { id: string, token: string, answers: any }) {
            try {
                const response = await api.post(`/contest/attempt/${id}/`, answers,{
                    headers: {
                        Authorization: `Bearer ${token}`,
                        "Content-Type": "application/json",
                    }
        ...
        static async studentContestSubmit({ id, token, answers }: { id: string, token: string, answers: any }) {
            try {
